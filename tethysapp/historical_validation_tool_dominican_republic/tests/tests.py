...
# from ..app import HistoricalValidationToolDominicanRepublic
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.historical_validation_tool_dominican_republic"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.historical_validation_tool_dominican_republic.tests.tests"

        To run tests in the HistoricalValidationToolDominicanRepublicTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.historical_validation_tool_dominican_republic.tests.tests.HistoricalValidationToolDominicanRepublicTestCase"

        To run only the test_if_tethys_platform_is_great function in the HistoricalValidationToolDominicanRepublicTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.historical_validation_tool_dominican_republic.tests.tests.HistoricalValidationToolDominicanRepublicTestCase.test_if_tethys_platform_is_great"
...
class HistoricalValidationToolDominicanRepublicTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(HistoricalValidationToolDominicanRepublic)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(HistoricalValidationToolDominicanRepublic)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/historical-validation-tool-dominican-republic/')  # The final '/' is essential for all pages/controllers
